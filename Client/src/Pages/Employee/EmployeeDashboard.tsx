            ...
            <div className="space-y-1">
              <button
                onClick={() => {
                  ...
                  setBulkUploadExpanded(!bulkUploadExpanded);
                }}
                className={cn(
                  'w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors',
                  isBulkUploadActive
              ...
              >
                ...
                {sidebarOpen && (
                  <>
                    <span className="font-medium flex-1 text-left">Bulk Upload</span>
                    {bulkUploadExpanded ? (
              ...
              {/* Bulk Upload Sub-menu */}
              {sidebarOpen && bulkUploadExpanded && (
